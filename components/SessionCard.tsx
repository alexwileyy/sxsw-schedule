...
export function SessionCard({ s, conflictsWith }: { s: Session; conflictsWith?: Session[] }) {
  ...
  return (
    ...
    >
      {/* Top row: score + time on the left (most important first), star alone on
          the right. Everything below spans the full card width. */}
      ...
      <h3 className="mt-2 break-words font-semibold leading-tight text-sxsw-black group-hover:text-sxsw-plum">
        {s.title}
      </h3>
      {s.venue && (
